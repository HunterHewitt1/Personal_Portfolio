...
Lorem Ipsum has been the industry's standard dummy text.</p>
                <Carousel responsive={responsive} infinite={true} className="skill-slider">
                  ...
                  <div className='item'>
                    <img src={"https://upload.wikimedia.org/wikipedia/commons/9/93/MongoDB_Logo.svg"} alt="Image"/>
                    <h5>MongoDB</h5>
                  </div>
                  <div className='item'>
                    <img src={"https://upload.wikimedia.org/wikipedia/commons/2/29/Postgresql_elephant.svg"} alt="Image"/>
                    <h5>PostgreSQL</h5>
                  </div>
                </Carousel>
            </div>
